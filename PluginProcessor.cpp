...
//==============================================================================
PeakEqualizerAudioProcessor::PeakEqualizerAudioProcessor()
                       ...
                       )
{
    ...
    m_parameterVTS = std::make_unique<AudioProcessorValueTreeState>(*this, nullptr, Identifier("PeakEqualizerVTS"),
...
//==============================================================================
const juce::String PeakEqualizerAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool PeakEqualizerAudioProcessor::acceptsMidi() const
{
...
bool PeakEqualizerAudioProcessor::producesMidi() const
{
...
bool PeakEqualizerAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double PeakEqualizerAudioProcessor::getTailLengthSeconds() const
{

    return 0.0;
}

int PeakEqualizerAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int PeakEqualizerAudioProcessor::getCurrentProgram()
{
    return 0;
}

void PeakEqualizerAudioProcessor::setCurrentProgram (int index)
{
    juce::ignoreUnused (index);
}

const juce::String PeakEqualizerAudioProcessor::getProgramName (int index)
{
    juce::ignoreUnused (index);
    return {};
}

void PeakEqualizerAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
    juce::ignoreUnused (index, newName);
}

//==============================================================================
void PeakEqualizerAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void PeakEqualizerAudioProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

bool PeakEqualizerAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void PeakEqualizerAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer,
...
//==============================================================================
bool PeakEqualizerAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* PeakEqualizerAudioProcessor::createEditor()
{
    return new PeakEqualizerAudioProcessorEditor (*this);
}

//==============================================================================
void PeakEqualizerAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void PeakEqualizerAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new PeakEqualizerAudioProcessor();
}
